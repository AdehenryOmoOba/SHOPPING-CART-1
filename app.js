...
function cartNumbers(product, action) {
  let productNumbers = localStorage.getItem("cartNumbers"); // This keeps a record of number of items we have added to our cart in the broswer local storage so that even after browser refresh, the record is kept in the local storage.
  productNumbers = parseInt(productNumbers); // This converts the product number logged into local storage from type 'string' to type 'number'.
